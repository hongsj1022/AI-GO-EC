...
@torch.no_grad()
def aigo_detect_test(weights='/home/aigo/detect/trafficlight/test4best.pt',  # model.pt path(s)
        source='/home/aigo/detect/image.jpg',  # file/dir/URL/glob, 0 for webcam
